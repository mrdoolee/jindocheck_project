        ...
        <div className="space-y-5 overflow-y-auto p-4 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ol className="list-decimal space-y-1 pl-5">
              ...
              <li>왼쪽 메뉴에서 학급을 눌러 진도체크·출결확인·누가기록·자리배치표 탭 이용 (과목이 2개 이상이면 진도체크 상단 버튼으로 전환)</li>
            </ol>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              왼쪽 메뉴의 "🕐 시간표"는 설정 &gt; 시간표 설정에서 등록한 시간표를 보여줍니다. 학교가
              컴시간알리미(comci.net)를 쓴다면 학교코드와 교사를 등록해 자동으로 불러오고, 다른 학년/반 시간표도
              조회할 수 있습니다. 컴시간알리미를 쓰지 않는 학교라면 "직접 입력"을 선택해 표에 직접 입력하세요 —
              직접 입력한 내용은 백업/Google 시트 동기화 대상에 포함됩니다. 계정 연결 없이 쓸 수 있고, 컴시간
              모드는 자동 새로고침이 되지 않습니다.
            </p>
          </section>
          <section>
